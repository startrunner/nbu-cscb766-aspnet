...
namespace FixMyHouse.Data.Migrations
{
    ...
    [Migration("20240923182505_AddCustomizationDataToReservations")]
    partial class AddCustomizationDataToReservations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FixMyHouse.Data.Entities.ServiceReservationEntity", b =>
                {
                    ...
                    b.OwnsOne("System.Collections.Generic.Dictionary<System.Guid, System.Guid>", "CustomizationGuids", b1 =>
                        {
                            b1.Property<Guid>("ServiceReservationEntityId")
                                .HasColumnType("uniqueidentifier");

                            b1.HasKey("ServiceReservationEntityId");

                            b1.ToTable("ServiceReservations");

                            b1.ToJson("CustomizationGuids");

                            b1.WithOwner()
                                .HasForeignKey("ServiceReservationEntityId");
                        });

                    b.OwnsOne("System.Collections.Generic.Dictionary<System.Guid, bool>", "CustomizationBooleans", b1 =>
                        {
                            b1.Property<Guid>("ServiceReservationEntityId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.ToJson("CustomizationBooleans");

                            b1.WithOwner()
                                .HasForeignKey("ServiceReservationEntityId");
                        });

                    b.OwnsOne("System.Collections.Generic.Dictionary<System.Guid, int>", "CustomizationWholeNumbers", b1 =>
                        {
                            b1.Property<Guid>("ServiceReservationEntityId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.ToJson("CustomizationWholeNumbers");
                    ...
                    b.Navigation("CustomizationBooleans")
                        .IsRequired();

                    b.Navigation("CustomizationGuids")
                        .IsRequired();

                    b.Navigation("CustomizationWholeNumbers")
                        .IsRequired();
