...
public class ApplicationDbContext : IdentityDbContext
{
    ...
    private static void OnSeedData(ModelBuilder builder)
    {
        ...
        builder
            ...
            .HasData([
                new() {
                    Ref_Artisan = artisanIds.GoshoPetrov,
                    Ref_Service = serviceIds.ThermalInsulation,
                ...
                new() {
                    Ref_Artisan = artisanIds.GoshoPetrov,
                    Ref_Service = serviceIds.RoofHydroInsulation,
                    CustomizationDefaults = [
                    new ServiceCustomizationEntity.WholeNumber {
                ...
                new() {
                    Ref_Artisan = artisanIds.PetarGeorgiev,
                    Ref_Service = serviceIds.BathroomTiles,
                    CustomizationDefaults = [
                    new ServiceCustomizationEntity.WholeNumber {
                ...
                new() {
                    Ref_Artisan = artisanIds.PetarGeorgiev,
                    Ref_Service = serviceIds.Laminate,
                    CustomizationDefaults = [
                    new ServiceCustomizationEntity.WholeNumber {
